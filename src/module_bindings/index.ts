...
import ReservationRow from "./reservation_table";
...
const tablesSchema = __schema({
  reservation: __table({
    name: 'reservation',
    indexes: [
      { accessor: 'reservation_date', name: 'reservation_date_idx_btree', algorithm: 'btree', columns: [
        'date',
      ] },
      { accessor: 'id', name: 'reservation_id_idx_btree', algorithm: 'btree', columns: [
        'id',
      ] },
      { accessor: 'reservation_spot_id', name: 'reservation_spot_id_idx_btree', algorithm: 'btree', columns: [
        'spotId',
      ] },
    ],
    constraints: [
      { name: 'reservation_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, ReservationRow),
  spot: __table({
    name: 'spot',
    indexes: [
      ...
      { accessor: 'name', name: 'spot_name_idx_btree', algorithm: 'btree', columns: [
        'name',
      ] },
    ],
    constraints: [
      { name: 'spot_id_key', constraint: 'unique', columns: ['id'] },
      { name: 'spot_name_key', constraint: 'unique', columns: ['name'] },
    ],
  }, SpotRow),
});
